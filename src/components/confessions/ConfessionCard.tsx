...
export function ConfessionCard({ confession, index, currentUserId, isFollowed = false }: ConfessionCardProps) {
    ...
    return (
        ...
        >
            {/* Sutura Border Container - Protection & Confidentiality Visual Metaphor */}
            <div className="sutura-border">
                {/* Left Border */}
                <div className="sutura-border-left" />

                {/* Right Border */}
                <div className="sutura-border-right" />

                {/* Confession Card Content */}
                <Card className="bg-card/40 backdrop-blur-md border-white/5 hover:border-primary/20 transition-colors duration-300 relative z-10">
                    <CardHeader className="flex flex-row items-start justify-between pb-2 space-y-0">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            {/* Menu Button */}
                            <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-foreground" onClick={() => setShowReportMenu(true)}>
